	...
	<div class="body-spidy-container">
		...
		<div class="spidy-container">
			...
			<div class="spidy-2">
				<div class="spidy-2-sub">
					<div class="spidy-2-sub-0">
						<p class="spidy-3-sub-heading-text">Coder</p>
					</div>
					<div class="spidy-2-sub-1">

						<div class="spidy-2-sub-1-div1">
							<a href="https://www.linkedin.com/in/varun-narayan-upadhyay-3a303a1ab/"> <span
								class="spidy-2-sub-1-span1-text">VN</span><span
								class="spidy-2-sub-1-span2-text">U</span> Varun
							</a>
						</div>
					...
					<div class="spidy-2-sub-2">
						<div class="spidy-2-sub-1-div1">
							<a href="https://www.linkedin.com/in/adarsh-patel-1a9149228/"> <span
								class="spidy-2-sub-1-span1-text">A</span><span
								class="spidy-2-sub-1-span2-text">P</span> Adharsh
							</a>
						</div>
					</div>
					<div class="spidy-2-sub-3">
						<div class="spidy-2-sub-1-div1">
							<a href="https://www.linkedin.com/in/zamiya-akbar-258226222/"> <span
								class="spidy-2-sub-1-span1-text">Z</span><span
								class="spidy-2-sub-1-span2-text">A</span> Zamiya
							</a>
						</div>
					</div>
