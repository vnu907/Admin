	...
	<div class="body-spidy-container">
		...
		<div class="process-page">
			<div class="inner-page">
				...
				<p>Last updated: March 10, 2022</p>
				...
				<ul>
					...
					<li>
						<p>
							...
							in this Agreement) refers to Airline Reservation System.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to Airline Reservation System,
							accessible from <a href="/"
								rel="external nofollow noopener" target="_blank">Airline Reservation</a>
						</p>
					</li>
					<li>
						<p>
				...
				<p>When You access the Service by or through a mobile device, We
				...
				<p>The Company allows You to create an account and log in to use
				...
				<p>If You decide to register through or otherwise grant us
					...
					account.</p>
				<p>You may also have the option of sharing additional
				...
				<ul>
					<li><strong>Cookies or Browser Cookies.</strong> A cookie is a
						...
						Cookies.</li>
					<li><strong>Flash Cookies.</strong> Certain features of our
						...
						rel="external nofollow noopener" target="_blank">https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_</a></li>
				...
				<p>Our Service does not address anyone under the age of 13. We
					...
					Our servers.</p>
				<p>If We need to rely on consent as a legal basis for processing
				...
				<ul>
					<li>By visiting this page on our website: <a
						href="/contact"
						rel="external nofollow noopener" target="_blank">Contact</a></li>
				</ul>
			</div>
